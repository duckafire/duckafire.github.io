...
class CardURLList
{
	...
	{
		const INPUT_ATTR = {
			className: "notranslate url-list-btn rounded-rect-btn url-list-text live-input",
			role: "button",
			value: url,
			type: "text",
			readOnly: "~",
...
class CardInfoPopup
{
	...
	static place()
	{
		...
		DIV( {className: "cards-info-container min-screen-width blured-bg low-light-bg", cssRules},
